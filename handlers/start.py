# ============================================================
# 🚀 START & (WITH OWNER BUTTON) - FULL WORKING CODE
# ============================================================
...
async def start_handler(client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton("📢 ᴜᴩᴅᴀᴛᴇ", url=f"https://t.me/{UPDATE_CHANNEL}" if 'UPDATE_CHANNEL' in globals() and UPDATE_CHANNEL else "https://t.me/krishna_bots"),
            InlineKeyboardButton("💬 ꜱᴜᴩᴩσʀᴛ", url=f"https://t.me/{SUPPORT_CHAT}" if 'SUPPORT_CHAT' in globals() and SUPPORT_CHAT else "https://t.me/+MoDgQrl3Cn0yNDRk")
        ],
        [
...
@filters.callback_query(filters.regex("^help_menu$"))
...
@filters.callback_query(filters.regex("^privacy_policy$"))
...
@filters.callback_query(filters.regex("^start_back$"))
