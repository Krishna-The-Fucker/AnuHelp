============================================================
​🔠 MEGA FONT & BIO STYLING SYSTEM (ULTRA PRO MAX)
​============================================================
​mod_name = "🔠 ғᴏɴᴛs & ʙɪᴏ"
​help = """
...
"royal_king_2": ("𝐀𝐁𝐂𝐃𝐄𝐅𝐆𝐇𝐈𝐉𝐊𝐋𝐌𝐍𝐎𝐏𝐐𝐑𝐒𝐓𝐔𝐕𝐖𝐗𝐘𝐙", "𝐚𝐛𝐜𝐝𝗲𝗳𝗴𝐡𝐢𝐣𝗸𝗹𝗺𝗻𝗼𝐩𝐪𝐫𝐬𝐭𝐮𝐯𝐰𝐱𝐲𝐳", "𝟎𝟏𝟐𝟑𝟒𝟓𝟔𝟕𝟖𝟗", "⚡ King Serif ⚡"),
"royal_king_3": ("𝒜ℬ𝒞𝒟ℰℱ𝒢ℋℐ𝒥𝒦ℒℳ𝒩𝒪𝒫𝒬ℛ𝒮𝒯𝒰𝒱𝒲𝒳𝒴𝒵", "𝒶𝒷𝒸𝒹ℯ𝒻ℊ𝒽𝒾𝒿𝓀𝓁𝓂𝓃ℴ𝓅𝓆𝓇𝓈𝓉𝓊𝓋𝓌𝓍𝓎𝒏", "0123456789", "💎 Royal Script 💎"),
"royal_king_4": ("𝓐𝓑𝓒𝓓𝓔𝓕𝓖𝓗𝓘𝓙𝓚𝓛𝓜𝓝𝓞𝓟𝓠𝓡𝓢𝓣𝓤𝓥𝓦𝓧Ψ𝓩", "𝓪𝚋𝓬𝓭𝓮𝙛ghijklmnopqrstuvwxyz", "𝟎𝟏𝟐𝟑𝟒𝟓𝟔𝟕𝟖𝟗", "🔥 Mafia Bold 🔥"),
...
"royal_king_7": ("ᴬᴮᶜᴰᴱᶠ𝅘𝅥𝅯ᴴᴵ𝴶𝴷ᴸᴹᴺᴼᴾQᴿˢᵀᵁᵂˣʸ𝶿", "ᵃᵇᶜᵈᵉᶠᵍʰᶦʲᵏˡᵐⁿᵒᵖ۹ʳˢᵗᵘᵛʷˣʸᶻ", "0123456789", "✨ Tiny Mini ✨"),
"royal_king_8": ("𝔸𝔹ℂ𝔻𝔼𝔽𝔾ℍ𝕀𝕁𝕂𝕃𝕄ℕ𝕆ℙℚℝ𝕊𝕍𝕎𝕏𝕐ℤ", "𝕒𝕓𝕔𝕕𝕖𝕗𝕘𝕙𝕚𝕛𝕜𝕝𝕞𝕟𝕠𝕡𝕢𝕣𝕤𝕥𝕦𝕧𝕨𝕩𝕪𝕫", "𝟘𝟙𝟚𝟛𝟜𝟝𝟞𝟟𝟠𝟡", "🌟 Double Struck 🌟"),
"royal_king_9": ("ⒶⒷⒸⒹⒺⒻⒼⒽⒾⒿⓀⓁⓂⓃⓄⓅⓆⓇⓈⓉⓊⓋⓌⓍⓎⓏ", "ⓐⓑⓒⓓⓔⓕⓖⓗⓘⓙⓚⓛⓜⓝⓞⓟⓠⓡⓢⓣⓤⓥⓦⓧⓨⓩ", "⓪①②③④⑤⑥⑦⑧⑨", "🎯 Circled Bull 🎯"),
"royal_king_10": ("🄰🄱🄲🄳🄴🄵🄶🄷🄸🄹🄺🄻🄼🄽🄾🄿𝕿𝕮𝕽𝕾𝕿𝖀𝖁𝖂𝖃𝖄𝖅", "𝖆𝖇𝖈𝖉𝖊𝖋𝖌𝖍𝖎𝙟𝖐𝖑𝖒𝖓𝖔ป𝖕𝖖𝖗𝖘𝖙𝖚𝖛𝖜𝖝𝖞𝖟", "0123456789", "🛡️ Boxed Shield 🛡️"),
}
​FONT_STYLES = {}
...
orig_line = [l for l in msg_text.split("\n") if l.startswith("• Original Name:") or l.startswith("• Original:")][0]
...
​try:
msg_text = cq.message.text
orig_line = [l for l in msg_text.split("\n") if l.startswith("• Original Name:") or l.startswith("• Original:") or l.startswith("• Selected Style:")][0]
# safely extract original text
if "• Original Name:" in msg_text:
original_text = [l for l in msg_text.split("\n") if l.startswith("• Original Name:")][0].split("")[1] else: original_text = [l for l in msg_text.split("\n") if l.startswith("• **Original:**")][0].split("")[1]
except Exception:
original_text = "King"
